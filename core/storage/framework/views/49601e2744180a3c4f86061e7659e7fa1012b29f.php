            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--18">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($user->wins->sum('win_bonus'))); ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Win Bonus'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.wins',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--12">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($user->lotteryTickets->count()); ?> <?php echo app('translator')->get('Tickets'); ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Total Buy Ticket'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.tickets',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--8">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($user->lotteryTickets->sum('total_price'))); ?> </h3>
                            <p class="text-white"><?php echo app('translator')->get('Total Buy Ticket in Amount'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.tickets',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--10">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($user->wins->count()); ?> <?php echo app('translator')->get('Tickets'); ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Total Win Ticket'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.wins',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($general->cur_sym); ?><?php echo e($user->wins->sum('win_bonus')); ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Total Win Bonus'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.wins',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">  <?php if( @$referral): ?> <?php echo e($referral->username); ?> <?php else: ?> <?php echo app('translator')->get('None'); ?> <?php endif; ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Referred By'); ?></p>
                        </div>
                        
                        
                        <?php if( @$referral != null ): ?> <a href="<?php echo e(route('admin.users.detail',$referral->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a> <?php else: ?> <?php echo app('translator')->get('None'); ?> <?php endif; ?>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($user->referral->count()); ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Total Referral'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.referrals',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white"><?php echo e($general->cur_sym); ?> <?php echo e($user->commissions->sum('amount')); ?></h3>
                            <p class="text-white"><?php echo app('translator')->get('Total Referral Commissions'); ?></p>
                        </div>
                        <a href="<?php echo e(route('admin.users.commissions.deposit',$user->id)); ?>" class="widget-two__btn"><?php echo app('translator')->get('View All'); ?></a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dlotonli/public_html/core/resources/views/admin/users/detail.blade.php ENDPATH**/ ?>